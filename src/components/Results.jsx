    ...
    <div className="results">
      <section className="section__results">
        ...
        <p className="results__message">
          {props.data_points} points, {props.data_message}
        </p>
        <p>·</p>
        <p>
          Game started at {props.data_started} and ended at {props.data_ended}
        </p>
        <p>Total playtime: {props.data_played}.</p>
        <p>Number of questions asked: {props.data_questions_total}</p>
        <p>
          Right: {props.data_right} -{" "}
          {(
            (Number(props.data_right) / Number(props.data_questions_total)) *
            100
          ).toFixed(2)}
          %
        </p>
        <p>
          Wrong: {props.data_wrong} -{" "}
          {(
            (Number(props.data_wrong) / Number(props.data_questions_total)) *
            100
          ).toFixed(2)}
          %
        </p>
        <p>
          Unanswered: {props.data_unanswered} -{" "}
          {(
            (Number(props.data_unanswered) /
              Number(props.data_questions_total)) *
            100
          ).toFixed(2)}
          %
        </p>
...
Results.propTypes = {
  ...
  data_unanswered: PropTypes.number,
  data_points: PropTypes.number,
  data_started: PropTypes.string,
  data_ended: PropTypes.string,
  data_played: PropTypes.string,
  data_message: PropTypes.string,
};
